...
export function Dashboard({ onNavigate }: DashboardProps) {
  ...
  return (
    <div className="space-y-10 pb-12">
      {/* 1. Hero Section */}
      <section className="relative overflow-hidden rounded-3xl border border-slate-200/90 bg-white p-6 sm:p-10 shadow-card">
        ...
        <div className="relative max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded-full bg-indigo-50 border border-indigo-100 px-3 py-1 text-xs font-bold text-primary">
            ...
            <span>OBJECTIF EXAMEN / EFM · OFPPT</span>
          </div>

          <h1 className="mt-4 text-3xl sm:text-5xl font-black tracking-tight text-slate-900 leading-[1.1]">
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-card">
          <div className="text-3xl sm:text-4xl font-black text-primary">{overallPercentage}%</div>
          <div className="text-sm font-bold text-slate-900 mt-1">Maîtrise Globale</div>
          <div className="text-xs text-slate-400 mt-0.5">Progression en temps réel</div>
        </div>

        <div className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-card">
          <div className="text-3xl sm:text-4xl font-black text-teal-600">200</div>
          <div className="text-sm font-bold text-slate-900 mt-1">QCM Spécialisés</div>
          <div className="text-xs text-slate-400 mt-0.5">150 cours + 50 examen final</div>
        </div>

        <div className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-card">
          <div className="text-3xl sm:text-4xl font-black text-emerald-600">5</div>
          <div className="text-sm font-bold text-slate-900 mt-1">Simulateurs Pratiques</div>
          <div className="text-xs text-slate-400 mt-0.5">PERT, Gantt, Jira, Git, CI/CD</div>
        </div>

        <div className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-card">
          <div className="text-3xl sm:text-4xl font-black text-amber-500">18</div>
          <div className="text-sm font-bold text-slate-900 mt-1">Flashcards 3D</div>
          <div className="text-xs text-slate-400 mt-0.5">Mémorisation des notions clés</div>
        </div>
      </section>

      {/* 3. Learning Path Timeline */}
      <section className="rounded-3xl border border-slate-200/90 bg-white p-6 sm:p-8 shadow-card">
        <div className="flex items-center justify-between pb-4 border-b border-slate-100">
          <div>
            <h2 className="text-xl font-bold text-slate-900">Parcours d’apprentissage</h2>
            <p className="text-xs text-slate-500 mt-0.5">Étapes recommandées pour une préparation complète</p>
          </div>
          <Badge variant="outline" size="sm">5 Modules + Examen</Badge>
        </div>

        <div className="mt-6 flex flex-wrap lg:flex-nowrap items-center justify-between gap-3">
            ...
            return (
              <React.Fragment key={part.id}>
                <button
                  ...
                  className="flex-1 min-w-[140px] text-left p-3.5 rounded-2xl border border-slate-200 hover:border-primary/50 hover:bg-indigo-50/30 transition-all group"
                >
          ...
          <button
            onClick={() => onNavigate('final-exam')}
            className="flex-1 min-w-[140px] text-left p-3.5 rounded-2xl border-2 border-primary/40 bg-indigo-50/40 hover:bg-indigo-50/80 transition-all group"
          >
            <div className="flex items-center justify-between text-[11px] mb-2 font-bold">
      ...
      <section>
        <div className="flex items-end justify-between mb-5">
          <div>
            <h2 className="text-2xl font-black text-slate-900 tracking-tight">Modules de cours</h2>
            <p className="text-sm text-slate-500 mt-1">Chaque module propose un cours éditorial, des exemples réels et 30 QCM d’entraînement.</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-5">
          {COURSE_PARTS.map((part) => {
            ...
            return (
              <div
                key={part.id}
                className="rounded-3xl border border-slate-200/90 bg-white p-6 shadow-card hover:shadow-hover transition-all duration-200 flex flex-col justify-between"
              >
                <div>
          ...
          <div className="rounded-3xl border-2 border-dashed border-slate-200 bg-slate-50/50 p-6 flex flex-col justify-between hover:border-slate-300 transition-colors">
            <div>
              ...
              <h3 className="text-lg font-bold text-slate-900 mt-2">Laboratoire Interactif</h3>
            ...
            <Button
              ...
              size="sm"
              onClick={() => onNavigate('simulators')}
              className="mt-6 font-bold text-teal-800 border-teal-200 hover:bg-teal-50"
            >
      ...
      <section className="grid sm:grid-cols-2 gap-5">
        <div className="rounded-3xl border border-slate-200/90 bg-white p-6 shadow-card flex items-start gap-4">
