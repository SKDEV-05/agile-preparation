    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="rounded-3xl border border-slate-200/90 bg-white p-6 sm:p-8 shadow-card">
        ...
        <p className="mt-3 text-sm text-slate-500 max-w-3xl leading-relaxed">
          Ici, tu ne te contentes pas de lire la théorie : tu manipules les outils et concepts exactement comme en entreprise ou lors des exercices pratiques des examens OFPPT.
        </p>
