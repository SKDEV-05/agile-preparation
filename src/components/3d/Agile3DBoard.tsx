...
export function Agile3DBoard() {
  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-slate-900/90 via-slate-900/60 to-[#070B14] p-5 sm:p-8 shadow-2xl backdrop-blur-xl space-y-6">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-5">
        <div>
          <div className="inline-flex items-center gap-2 text-xs font-mono font-bold text-indigo-400 uppercase tracking-wider mb-1">
        ...
        <div className="flex items-center gap-1.5 rounded-full bg-slate-800/80 border border-white/10 px-3 py-1 text-xs text-slate-300 font-medium self-start sm:self-auto">
          ...
          return (
            <button
              ...
              className={`p-3 rounded-2xl border text-left transition-all duration-200 group ${
                isActive
                  ? `bg-slate-800/90 ${p.borderColor} shadow-lg shadow-indigo-500/10 scale-[1.02]`
      ...
      <div className="grid lg:grid-cols-12 gap-6 items-center rounded-2xl border border-white/10 bg-black/40 p-5 sm:p-7">
        {/* Left Explanation & Exam Checklist */}
        <div className="lg:col-span-6 space-y-4">
          <div className="flex items-center gap-2 text-xs font-mono font-bold text-slate-400">
            <span className={`px-2 py-0.5 rounded-md bg-white/5 border ${currentPillar.borderColor} ${currentPillar.textColor}`}>
          ...
          <div className="rounded-xl bg-indigo-950/30 border border-indigo-500/20 p-3.5 text-xs text-slate-300 leading-relaxed space-y-1.5">
          ...
          <div className="grid grid-cols-2 gap-3 text-xs">
            <div className="p-3 rounded-xl bg-slate-900/80 border border-white/5 space-y-1">
              <div className="text-[10px] font-mono uppercase text-slate-400">Question Fréquente</div>
            ...
            <div className="p-3 rounded-xl bg-slate-900/80 border border-white/5 space-y-1">
              <div className="text-[10px] font-mono uppercase text-emerald-400">Réponse Clé</div>
        ...
        <div className="lg:col-span-6 relative flex justify-center items-center min-h-[220px] perspective-1000">
          {activePillar === 'scrum' && (
            <div className="w-full space-y-3 transform-style-preserve-3d animate-float-subtle">
              <div className="grid grid-cols-3 gap-2 text-center text-xs">
                <div className="p-3 rounded-xl bg-gradient-to-b from-indigo-900/40 to-slate-900/80 border border-indigo-500/30">
                  <Users className="h-5 w-5 text-indigo-400 mx-auto mb-1" />
                  <div className="font-bold text-white text-xs">Product Owner</div>
                  <div className="text-[9px] text-indigo-300">Porte la Vision</div>
                </div>
                <div className="p-3 rounded-xl bg-gradient-to-b from-cyan-900/40 to-slate-900/80 border border-cyan-500/30 scale-105 shadow-xl shadow-cyan-500/10">
                  <Zap className="h-5 w-5 text-cyan-400 mx-auto mb-1" />
                  <div className="font-bold text-white text-xs">Scrum Master</div>
                  <div className="text-[9px] text-cyan-300">Facilitateur</div>
                </div>
                <div className="p-3 rounded-xl bg-gradient-to-b from-purple-900/40 to-slate-900/80 border border-purple-500/30">
                  <Layers className="h-5 w-5 text-purple-400 mx-auto mb-1" />
                  <div className="font-bold text-white text-xs">Dev Team</div>
                  <div className="text-[9px] text-purple-300">Auto-organisée</div>
                </div>
              </div>
              <div className="p-2.5 rounded-xl bg-slate-900/90 border border-white/10 text-center font-mono text-[10px] text-slate-300">
            ...
            <div className="w-full grid grid-cols-3 gap-2 text-xs transform-style-preserve-3d animate-float-subtle">
              <div className="p-2.5 rounded-xl bg-slate-900/80 border border-white/10 space-y-2">
                <div className="text-[10px] font-bold text-slate-400 flex items-center justify-between">
                  <span>To Do</span>
                  <span className="text-slate-500">WIP 4</span>
                </div>
                <div className="p-1.5 rounded bg-slate-800 text-[9px] text-slate-300 border border-white/5">US-12 PERT</div>
                <div className="p-1.5 rounded bg-slate-800 text-[9px] text-slate-300 border border-white/5">US-14 Gantt</div>
              </div>
              <div className="p-2.5 rounded-xl bg-cyan-950/40 border border-cyan-500/40 space-y-2 shadow-lg">
                <div className="text-[10px] font-bold text-cyan-300 flex items-center justify-between">
                  <span>In Progress</span>
                  <span className="text-cyan-400 font-bold">WIP 2 (MAX)</span>
                </div>
                <div className="p-1.5 rounded bg-cyan-900/60 text-[9px] text-white border border-cyan-400/40 animate-pulse">
                  US-08 Scrum Poker
                </div>
              </div>
              <div className="p-2.5 rounded-xl bg-emerald-950/40 border border-emerald-500/40 space-y-2">
                <div className="text-[10px] font-bold text-emerald-300 flex items-center justify-between">
                  <span>Done</span>
                  <span className="text-emerald-400">DoD ✓</span>
                </div>
                <div className="p-1.5 rounded bg-emerald-900/60 text-[9px] text-white border border-emerald-400/40">
                  US-02 Manifeste ✓
                </div>
              </div>
            </div>
          ...
          {activePillar === 'sprint' && (
            <div className="w-full space-y-3 transform-style-preserve-3d animate-float-subtle">
              <div className="flex items-center justify-between text-xs text-slate-300 px-2 font-mono">
                <span>Jour 1 : Planning</span>
                <span className="text-emerald-400 font-bold">Timebox 2 semaines</span>
                <span>Jour 14 : Demo</span>
              </div>
              <div className="relative h-4 rounded-full bg-slate-800 border border-white/10 overflow-hidden">
                <div className="h-full bg-gradient-to-r from-emerald-500 via-cyan-500 to-indigo-500 w-3/4 rounded-full"></div>
              </div>
              <div className="grid grid-cols-2 gap-2 text-[10px]">
                <div className="p-2 rounded-lg bg-slate-900/90 border border-white/10 text-slate-300">
                  🎯 <b className="text-white">Sprint Goal :</b> Livrer le calcul PERT interactif.
                </div>
                <div className="p-2 rounded-lg bg-slate-900/90 border border-white/10 text-slate-300">
                  ⚡ <b className="text-white">Vélocité :</b> 35 Story Points / Sprint.
                </div>
              </div>
            </div>
          )}
          ...
          {activePillar === 'backlog' && (
            <div className="w-full space-y-2 transform-style-preserve-3d animate-float-subtle">
              <div className="p-2.5 rounded-xl bg-indigo-950/50 border border-indigo-500/40 text-xs text-white flex items-center justify-between">
                <span>En tant que stagiaire, je veux un simulateur PERT...</span>
                <span className="px-2 py-0.5 rounded bg-indigo-600 text-[9px] font-bold">8 pts</span>
              </div>
              <div className="p-2.5 rounded-xl bg-slate-900/80 border border-white/10 text-xs text-slate-300 flex items-center justify-between">
                <span>En tant que formateur, je veux exporter les scores...</span>
                <span className="px-2 py-0.5 rounded bg-slate-800 text-[9px] font-bold">5 pts</span>
              </div>
          ...
          {activePillar === 'daily' && (
            <div className="w-full p-4 rounded-2xl bg-gradient-to-br from-rose-950/40 to-slate-900 border border-rose-500/30 space-y-3 transform-style-preserve-3d animate-float-subtle">
              <div className="flex items-center justify-between text-xs font-bold text-rose-300">
                <span className="flex items-center gap-1.5"><Clock className="h-4 w-4" /> 15 Minutes Stand-up</span>
                <span className="text-[9px] bg-rose-500/20 px-2 py-0.5 rounded-full border border-rose-500/40">Debout</span>
              </div>
          ...
          {activePillar === 'retro' && (
            <div className="w-full grid grid-cols-3 gap-2 text-center text-xs transform-style-preserve-3d animate-float-subtle">
              <div className="p-2.5 rounded-xl bg-emerald-950/40 border border-emerald-500/30">
                <div className="text-[10px] font-bold text-emerald-300 mb-1">Ce qui a marché</div>
                <div className="text-[9px] text-slate-300">Bonne communication sur Git</div>
              </div>
              <div className="p-2.5 rounded-xl bg-rose-950/40 border border-rose-500/30">
                <div className="text-[10px] font-bold text-rose-300 mb-1">À améliorer</div>
                <div className="text-[9px] text-slate-300">Conflits de merge trop tardifs</div>
              </div>
              <div className="p-2.5 rounded-xl bg-indigo-950/40 border border-indigo-500/30">
                <div className="text-[10px] font-bold text-indigo-300 mb-1">Actions Sprint+1</div>
                <div className="text-[9px] text-slate-300">Revue de PR quotidienne</div>
              </div>
            </div>
          )}
        </div>
